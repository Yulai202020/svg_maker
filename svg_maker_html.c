...
int main(int argc, char** argv) {
    ...
    if (strcmp(type, "circle") == 0) {
        ...
        char* x1 = readline("Input x: ");
        char* y1 = readline("Input y: ");
        char* x2 = readline("Input height: ");
        char* y2 = readline("Input width: ");
        char* style = readline("Input style: ");
        ...
        if (strcmp(style, "") == 0) {
            snprintf(tag, MAX_LINE_LENGTH, "<rect x=\"%s\" y=\"%s\" height=\"%s\" width=\"%s\"/>", x1, y1, x2, y2);
        } else {
            snprintf(tag, MAX_LINE_LENGTH, "<rect x=\"%s\" y=\"%s\" height=\"%s\" width=\"%s\" style=\"%s\"/>", x1, y1, x2, y2, style);
        }
